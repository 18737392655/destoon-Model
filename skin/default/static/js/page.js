...
function setModule2(i, n) {console.log(i,n); Dd('destoon_search2').action = DTPath+'api/search.php';Dd('destoon_moduleid2').value = i;searchid = i;Dd('destoon_select2').value = n;$('#search_module2').fadeOut('fast');Dd('destoon_kw2').focus();}
