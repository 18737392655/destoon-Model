...
<tr>
<td class="tl">标题图片</td>
<td class="tr"><input name="post[thumb]" id="thumb" type="text" size="60" value="<?php echo $thumb;?>" readonly/>&nbsp;&nbsp;<a href="javascript:void(0);" onclick="Dthumb(<?php echo $moduleid;?>,<?php echo $MOD['thumb_width'];?>,<?php echo $MOD['thumb_height'];?>, Dd('thumb').value, true);" class="t">[上传]</a>&nbsp;&nbsp;<span onclick="_preview(Dd('thumb').value);" class="jt">[预览]</span>&nbsp;&nbsp;<span onclick="Dd('thumb').value='';" class="jt">[删除]</span> <span id="dthumb" class="f_red"></span></td>
</tr>
<?php if($MOD['swfu']==1 && $MG['upload'] && check_group($_groupid, $MOD['group_upload'])) { ?>
<tr>
<td class="tl"><span class="f_red">*</span> 文件地址</td>
<td class="tr"><div style="float:left;"><input name="post[fileurl]" id="fileurl" type="text" size="60" value="<?php echo $fileurl;?>"/>&nbsp;&nbsp;</div><div style="width:34px;height:20px;float:left;"><span id="spanButtonPlaceHolder"></span></div><table cellspacing="0" style="display:none;">
<tr>
<td>Files Queued:</td>
...
<script type="text/javascript" src="<?php echo $MODULE['1']['linkurl'];?>api/swfupload/handlers_down.js"></script>
...
<tr>
<td class="tl"><span class="f_red">*</span> 文件地址</td>
<td class="tr"><input name="post[fileurl]" id="fileurl" type="text" size="60" value="<?php echo $fileurl;?>"/><?php if($MG['upload'] && check_group($_groupid, $MOD['group_upload'])) { ?>&nbsp;&nbsp;<span onclick="Dfile(<?php echo $moduleid;?>, Dd('fileurl').value, 'fileurl', '<?php echo $MOD['upload'];?>');" class="jt">[上传]</span>&nbsp;&nbsp;<span onclick="if(Dd('fileurl').value) window.open(Dd('fileurl').value);" class="jt">[预览]</span>&nbsp;&nbsp;<span onclick="Dd('fileurl').value='';" class="jt">[删除]</span><?php } ?> <span id="dfileurl" class="f_red"></span></td>
</tr>
<?php } ?>
<tr>
<td class="tl"><span class="f_red">*</span> 文件类型</td>
<td class="tr"><?php echo ext_select('post[fileext]', $fileext, 'id="fileext"');?></td>
</tr>
<tr>
<td class="tl"><span class="f_red">*</span> 文件大小</td>
<td class="tr"><input name="post[filesize]" id="filesize" type="text" size="10" value="<?php echo $filesize;?>"/>&nbsp;<?php echo unit_select('post[unit]', $unit, 'id="unit"');?>&nbsp;<span id="dfilesize" class="f_red"></span></td>
</tr>
<?php if($CP) { ?>
<script type="text/javascript">
...
<?php } ?>
<td class="f_gray"><?php echo $v['download'];?></td>
