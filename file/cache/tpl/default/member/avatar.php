...
<img src="<?php echo useravatar($_username, 'large');?>&reload=<?php echo $DT_TIME;?>" width="128" height="128" title="大头像"/>
<?php if($avatar) { ?><br/><br/><a href="?action=delete<?php if($action=='html') { ?>&html=1<?php } ?>" class="t" onclick="return confirm('确定要删除个人头像吗？');">[删除头像]</a><?php } ?>
</td>
