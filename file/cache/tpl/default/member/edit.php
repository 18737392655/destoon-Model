...
<div class="ok">资料保存成功，您可以：<a href="?action=index" class="b">继续完善</a> &nbsp;|&nbsp; <a href="<?php echo $DT['file_my'];?>" class="b">发布信息</a> &nbsp;|&nbsp; <a href="./" class="b">返回商务室首页</a></div>
<?php } ?>
<div class="menu">
...
<tr>
<td class="tl">头像</td>
<td class="tr f_b"><a href="avatar.php"><img src="<?php echo useravatar($_username, 'large');?>&reload=<?php echo $DT_TIME;?>" width="128" height="128" title="点击修改"/></a></td>
</tr> 
<tr>
<td class="tl">昵称</td>
<td class="tr"><?php echo $_passport;?><?php if($_passport == $_username) { ?>&nbsp;&nbsp;<a href="send.php?action=passport" class="b">[修改]</a><?php } ?></td>
</tr>
<tr>
<td class="tl">邮件</td>
<td class="tr"><?php echo $_email;?><?php if($vemail) { ?>&nbsp;&nbsp;<img src="image/v_email.gif" title="已认证" align="absmiddle"/><?php } ?><?php if($DT['mail_type'] != 'close') { ?>&nbsp;&nbsp;<a href="send.php?action=email" class="b">[修改]</a><?php } ?></td>
</tr>
<?php if($vmobile) { ?>
<tr>
<td class="tl">手机</td>
<td class="tr"><input type="hidden" name="post[mobile]" id="mobile" value="<?php echo $mobile;?>"/><?php echo $mobile;?>&nbsp;&nbsp;<img src="image/v_mobile.gif" title="已认证" align="absmiddle"/><?php if($DT['sms']) { ?>&nbsp;&nbsp;<a href="send.php?action=mobile" class="b">[修改]</a><?php } ?></td>
</tr>
<?php } else { ?>
<tr>
<td class="tl">手机</td>
...
<td class="tr">
<input type="radio" name="post[gender]" value="1" <?php if($gender==1) { ?>checked="checked"<?php } ?>/> 先生
<input type="radio" name="post[gender]" value="2" <?php if($gender==2) { ?>checked="checked"<?php } ?>/> 女士
</td>
</tr>
<?php if(!$is_company) { ?>
<tr>
...
<td class="tr"><input name="post[wxqr]" type="text" size="60" id="wxqr" value="<?php echo $wxqr;?>" readonly/>&nbsp;&nbsp;<span onclick="Dthumb(<?php echo $moduleid;?>,128,128, Dd('wxqr').value, true, 'wxqr');" class="jt">[上传]</span>&nbsp;&nbsp;<span onclick="_preview(Dd('wxqr').value);" class="jt">[预览]</span>&nbsp;&nbsp;<span onclick="Dd('wxqr').value='';" class="jt">[删除]</span></td>
</tr>
<?php } ?>
<?php if($DT['im_ali']) { ?>
<tr>
...
<td class="tr"><?php echo dselect($COM_TYPE, 'post[type]', '请选择', $type, 'id="type"', 0);?><?php if(in_array('type', $_E)) { ?>&nbsp;<?php if(isset($_U['type'])) { ?><span class="f_red">审核中</span><?php } else { ?><span class="f_gray">需审核</span><?php } ?><?php } ?>&nbsp;<span id="dtype" class="f_red"></span></td>
</tr>
<tr>
<td class="tl"><span class="f_red">*</span>所在地区</td>
<td class="tr"><?php echo ajax_area_select('post[areaid]', '请选择', $areaid);?><?php if(in_array('areaid', $_E)) { ?>&nbsp;<?php if(isset($_U['areaid'])) { ?><span class="f_red">审核中</span><?php } else { ?><span class="f_gray">需审核</span><?php } ?><?php } ?>&nbsp;<span id="dareaid" class="f_red"></span></td>
</tr>
<tr>
...
<div id="catesch"></div>
<span id="cate"><?php echo ajax_category_select('', '请选择行业', 0, 4);?></span> &nbsp; <a href="javascript:cate_add(<?php echo $MOD['cate_max'];?>);" class="b">添加</a><?php if($DT['schcate_limit']) { ?> &nbsp; <a href="javascript:schcate(4);" class="b">搜索</a><?php } ?>
<div id="cate-box">
<div id="cate-tip"<?php if($cates) { ?>style="display:none;"<?php } ?>>请添加主营行业，最多可添加 <strong class="f_red"><?php echo $MOD['cate_max'];?></strong> 个</div>
...
<td class="tr"><input type="text" size="80" name="post[business]" id="business" value="<?php echo $business;?>" maxlength="250"/><?php if(in_array('business', $_E)) { ?>&nbsp;<?php if(isset($_U['business'])) { ?><span class="f_red">审核中</span><?php } else { ?><span class="f_gray">需审核</span><?php } ?><?php } ?>&nbsp;<span id="dbusiness" class="f_red"></span></td>
</tr>
<tr>
<td class="tl"><span class="f_red">*</span>成立年份</td>
<td class="tr"><input type="text" size="15" name="post[regyear]" id="regyear" value="<?php echo $regyear;?>" maxlength="4"/><?php if(in_array('regyear', $_E)) { ?>&nbsp;<?php if(isset($_U['regyear'])) { ?><span class="f_red">审核中</span><?php } else { ?><span class="f_gray">需审核</span><?php } ?><?php } ?>&nbsp;<span id="dregyear" class="f_red"></span> <span class="f_gray">(年份，如：2004)</span></td>
</tr>
<tr>
<td class="tl">形象图片</td>
...
<?php if(in_array('thumb', $_E)) { ?>&nbsp;<?php if(isset($_U['thumb'])) { ?><span class="f_red">审核中</span><?php } else { ?><span class="f_gray">需审核</span><?php } ?><?php } ?>
...
<tr>
<td class="tl">注册资本</td>
<td class="tr"><?php echo dselect($MONEY_UNIT, 'post[regunit]', '', $regunit, '', 0);?> <input type="text" size="6" name="post[capital]" id="capital" value="<?php echo $capital;?>"/> 万<?php if(in_array('capital', $_E)) { ?>&nbsp;<?php if(isset($_U['capital'])) { ?><span class="f_red">审核中</span><?php } else { ?><span class="f_gray">需审核</span><?php } ?><?php } ?></td>
</tr>
<tr>
...
<td class="tr"><input type="text" size="60" name="post[address]" id="daddress" value="<?php echo $address;?>" maxlength="200"/><?php if(in_array('address', $_E)) { ?>&nbsp;<?php if(isset($_U['address'])) { ?><span class="f_red">审核中</span><?php } else { ?><span class="f_gray">需审核</span><?php } ?><?php } ?>&nbsp;<span id="ddaddress" class="f_red"></span></td>
</tr>
<tr>
<td class="tl">邮政编码</td>
<td class="tr"><input type="text" size="8" name="post[postcode]" id="postalcode" value="<?php echo $postcode;?>"/></td>
...
<td class="tr"><input type="text" size="20" name="post[telephone]" id="telephone" value="<?php echo $telephone;?>"/><?php if(in_array('telephone', $_E)) { ?>&nbsp;<?php if(isset($_U['telephone'])) { ?><span class="f_red">审核中</span><?php } else { ?><span class="f_gray">需审核</span><?php } ?><?php } ?>&nbsp;<span id="dtelephone" class="f_red"></span></td>
</tr>
<tr>
<td class="tl">公司传真</td>
...
<td class="tr"><input type="text" size="20" name="post[gzh]" id="gzh" value="<?php echo $gzh;?>"/><?php if(in_array('gzh', $_E)) { ?>&nbsp;<?php if(isset($_U['gzh'])) { ?><span class="f_red">审核中</span><?php } else { ?><span class="f_gray">需审核</span><?php } ?><?php } ?></td>
</tr>
<tr>
<td class="tl">公众号二维码</td>
<td class="tr"><input name="post[gzhqr]" type="text" size="60" id="gzhqr" value="<?php echo $gzhqr;?>" readonly/>&nbsp;&nbsp;<span onclick="Dthumb(<?php echo $moduleid;?>, 128, 128, <?php if(in_array('gzhqr', $_E)) { ?>''<?php } else { ?>Dd('gzhqr').value<?php } ?>, true, 'gzhqr');" class="jt">[上传]</span>&nbsp;&nbsp;<span onclick="_preview(Dd('gzhqr').value);" class="jt">[预览]</span>&nbsp;&nbsp;<span onclick="Dd('gzhqr').value='';" class="jt">[删除]</span>
<?php if(in_array('gzhqr', $_E)) { ?>&nbsp;<?php if(isset($_U['gzhqr'])) { ?><span class="f_red">审核中</span><?php } else { ?><span class="f_gray">需审核</span><?php } ?><?php } ?></td>
</tr>
</tbody>
...
<?php if(in_array('content', $_E)) { ?><?php if(isset($_U['content'])) { ?><span class="f_red">审核中</span><?php } else { ?><span class="f_gray">需审核</span><?php } ?>&nbsp;<?php } ?><span id="dcontent" class="f_red"></span></td>
</tr>
</tbody>
<?php } ?>
<?php if($need_captcha) { ?>
