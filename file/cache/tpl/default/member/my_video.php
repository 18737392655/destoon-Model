...
<tr>
<td class="tl"><span class="f_red">*</span> <?php echo $MOD['name'];?>地址</td>
<td class="tr"><input name="post[video]" type="text" id="video" size="60" value="<?php echo $video;?>" onblur="UpdateURL();"/><?php if($MG['upload'] && check_group($_groupid, $MOD['group_upload'])) { ?>&nbsp;&nbsp;<span onclick="Dfile(<?php echo $moduleid;?>, Dd('video').value, 'video', '<?php echo $MOD['upload'];?>');" class="jt">[上传]</span><?php } ?>&nbsp;&nbsp;<span onclick="vs();" class="jt">[预览]</span>&nbsp;&nbsp;<span onclick="Dd('video').value='';" class="jt">[删除]</span> <span id="dvideo" class="f_red"></span>
</td>
</tr>
<?php } ?>
<tr>
