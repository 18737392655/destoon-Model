...
<img src="<?php if($U['avatar']) { ?><?php echo $U['avatar'];?><?php } else { ?><?php echo DT_PATH;?>api/oauth/avatar.png<?php } ?>" width="50" style="margin:30px 0 10px 0;border-radius:50%;"/>
...
<td><?php if($lists[$k]['url']) { ?><a href="<?php echo $lists[$k]['url'];?>" target="_blank"><?php } ?><img src="<?php if($lists[$k]['avatar']) { ?><?php echo $lists[$k]['avatar'];?><?php } else { ?><?php echo DT_PATH;?>api/oauth/avatar.png<?php } ?>" width="50" style="margin:10px;"/><?php if($lists[$k]['url']) { ?></a><?php } ?></td>
<td><?php if($lists[$k]['url']) { ?><a href="<?php echo $lists[$k]['url'];?>" target="_blank" class="b"><?php } ?><?php echo $lists[$k]['nickname'];?><?php if($lists[$k]['url']) { ?></a><?php } ?></td>
