...
<tr>
<td colspan="2"><img src="<?php echo DT_SKIN;?>image/btn_price.jpg" alt="报价" class="c_p" onclick="Go('<?php echo $MOD['linkurl'];?><?php echo rewrite('price.php?itemid='.$itemid);?>');"/></td>
</tr>
<?php } ?>
</table>
</td>
