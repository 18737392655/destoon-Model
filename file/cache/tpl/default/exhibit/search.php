...
<b>状态</b>
<select name="process">
<option value="0"<?php if($process == 0) { ?> selected<?php } ?>>全部</option>
<option value="1"<?php if($process == 1) { ?> selected<?php } ?>>未开始</option>
<option value="2"<?php if($process == 2) { ?> selected<?php } ?>>进行中</option>
<option value="3"<?php if($process == 3) { ?> selected<?php } ?>>已过期</option>
</select>
</div>
<div class="c_b"></div>
</div>
