...
<div class="list-img list0"><?php echo tag("moduleid=$moduleid&condition=status=3 and level>0&areaid=$cityid&order=".$MOD['order']."&width=180&height=135&datetype=3&lazy=$lazy&pagesize=".$MOD['page_irec']."&template=list-video");?></div>
<?php } ?>
...
<div class="list-img list0"><?php echo tag("moduleid=$moduleid&condition=status=3&catid=".$c['catid']."&areaid=$cityid&order=".$MOD['order']."&width=180&height=135&datetype=3&lazy=$lazy&pagesize=".$MOD['page_icat']."&template=list-video");?></div>
<?php } } ?>
<?php } ?>
</div>
