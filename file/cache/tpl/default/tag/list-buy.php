...
<td align="left">
<ul>
<li><?php if($t['vip']) { ?><span class="f_r"><img src="<?php echo DT_SKIN;?>image/vip_<?php echo $t['vip'];?>.gif" alt="<?php echo VIP;?>" title="<?php echo VIP;?>:<?php echo $t['vip'];?>级"/></span><?php } ?><a href="<?php echo $t['linkurl'];?>" target="_blank"><strong class="px14"><?php echo $t['title'];?></strong></a></li>
<li class="f_gray"><?php echo $t['introduce'];?></li>
<li><span class="f_r"><?php echo timetodate($t['edittime'], $datetype);?>&nbsp;&nbsp;</span>
<span class="f_gray">&nbsp;&nbsp;<?php if(!$t['username']) { ?> [未注册]<?php } ?></span>
</li>
</ul>
</td>
<td width="100" class="f_gray" align="center">[<?php echo area_pos($t['areaid'], '', 1);?>]</td>
</tr>
</table>
</div>
<?php } } ?>
