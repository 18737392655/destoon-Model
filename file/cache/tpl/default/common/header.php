...
<div class="xh-cart"><a onclick="msg(0,'采购功能正在维护,敬请期待!')"><i class="icon i-cart"></i>采购单</a>(<span class="head_t"
...
<a onclick="msg(0,'敬请期待!')" target="_blank">
<h4>采购服务</h4>
</a>
<p class="bm_x">
<a class="red" onclick="msg(0,'敬请期待!')" target="_blank">服务介绍</a>
<a onclick="msg(0,'敬请期待!')" target="_blank">服务对比</a>
<a onclick="msg(0,'敬请期待!')" target="_blank">建站服务</a>
<a onclick="msg(0,'敬请期待!')" target="_blank">精美商铺</a>
</p>
<a href="<?php echo $EXT['spread_url'];?>" target="_blank">
<h4>推广服务</h4>
</a>
<p class="bm_x">
<a class="red" href="<?php echo $EXT['spread_url'];?>" target="_blank">排名推广</a>
<a href="<?php echo $EXT['gift_url'];?>" target="_blank">积分商城</a>
<a href="<?php echo $EXT['guestbook_url'];?>" target="_blank">意见反馈</a>
...
<li class="m-li"><a href="/<?php echo $m['moduledir'];?>"><?php echo $m['name'];?></a><span> | </span></li>
<?php } ?>
<?php } } ?>
</ul>
</div>
</li>
<li class="top-r-li"><a onclick="msg(0,'客服功能暂未开放!')" target="_blank" class="smartkf">客服中心</a></li>
</ul>
</div>
</div>
</div>
...
<form id="destoon_search" action="<?php echo $MODULE[$searchid]['linkurl'];?>search.php">
<input type="hidden" name="moduleid" value="5" id="destoon_moduleid"/>
<input type="hidden" name="spread" value="0" id="destoon_spread"/>
<div class="reach-txt">
<ul class="option">
<?php $tags12=tag("table=category&condition=catdir!=1&group=moduleid&order=moduleid asc&template=null");?>
<?php if(is_array($tags12)) { foreach($tags12 as $key12 => $val12) { ?>
<li class="<?php if($key12==0) { ?>hover<?php } ?>" onclick="setModule('<?php echo $val12['moduleid'];?>',this)" id="select_value"><?php echo $MODULE[$val12['moduleid']]['name'];?></li>
<?php } } ?>
</ul>
</div>
<div class="reach-box">
