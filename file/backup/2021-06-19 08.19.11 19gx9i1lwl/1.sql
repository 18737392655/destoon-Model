# DESTOON V7.0 R20190416 https://www.destoon.com
# 2021-06-19 08:19:11
# --------------------------------------------------------
...
CREATE TABLE `destoon_admin_log` (
  ...
  PRIMARY KEY (`logid`)
) ENGINE=MyISAM AUTO_INCREMENT=516 DEFAULT CHARSET=utf8 COMMENT='管理日志';
...
INSERT INTO `destoon_admin_online` VALUES('9dnj1pmvud1ka2tqmh1lumnh82','destoon','127.0.0.1','1','action=todo&rand=1624061398','1624061399');
INSERT INTO `destoon_admin_online` VALUES('1d7d5aen6sqek08gkp6ah432dt','destoon','127.0.0.1','1','file=setting','1624061531');
INSERT INTO `destoon_admin_online` VALUES('obca6piuh612l83o3mjdeo1jtk','destoon','127.0.0.1','1','','1624061951');
...
CREATE TABLE `destoon_article_21` (
  ...
  KEY `catid` (`catid`),
  KEY `username` (`username`)
) ENGINE=MyISAM AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='资讯';
...
CREATE TABLE `destoon_buy_6` (
  ...
  KEY `catid` (`catid`),
  KEY `areaid` (`areaid`)
) ENGINE=MyISAM AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='求购';
...
INSERT INTO `destoon_cache` VALUES('d23013315f164502d8a2e82986f62639','1624064990');
...
CREATE TABLE `destoon_category` (
  ...
  PRIMARY KEY (`catid`)
) ENGINE=MyISAM AUTO_INCREMENT=49 DEFAULT CHARSET=utf8 COMMENT='栏目分类';
...
INSERT INTO `destoon_chat` VALUES('d7e44b943281ba88098d93dc7a930cbd','zq78900','1623896425','1623897301','0','destoon','1623892805','1623922373','0','111','1623896425','http://jpzzw.ja39.7890010.com/mall/show.php?itemid=8');
...
CREATE TABLE `destoon_chat_data_7` (
  ...
  KEY `chatid` (`chatid`),
  KEY `addtime` (`addtime`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='聊天记录_7';
...
INSERT INTO `destoon_cron` VALUES('1','更新在线状态','1','online','10','1624061302','1624061902','0','');
INSERT INTO `destoon_cron` VALUES('2','内容分表创建','1','split','0,0','1624061302','1624118400','0','');
INSERT INTO `destoon_cron` VALUES('3','清理过期文件缓存','0','cache','30','1624061302','1624063102','0','');
...
CREATE TABLE `destoon_info_22` (
  ...
  KEY `areaid` (`areaid`),
  KEY `editdate` (`editdate`,`vip`,`edittime`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='招商';

INSERT INTO `destoon_info_22` VALUES('1','31','1','河南中企正新鸡排宝','','0','河南中企正新鸡排宝,首页招商推荐全国','','3','0','http://jpzzw.ja39.7890010.com/file/upload/202106/10/145446331.jpg.thumb.jpg','','','','destoon','1','1623307964','2021-06-10','1625932799','0','DESTOON B2B网站管理系统','0','0','姓名','','','','','','','','','','','预算','','','10000-20000元','','','destoon','1623308090','2021-06-10','127.0.0.1','','3','0','0','show.php?itemid=1','','');
INSERT INTO `destoon_info_22` VALUES('2','31','1','河南中企正新鸡排宝','','0','河南中企正新鸡排宝,首页招商推荐全国','','1','0','http://jpzzw.ja39.7890010.com/file/upload/202106/10/145523261.jpg.thumb.jpg','','','','destoon','1','1623308090','2021-06-10','1625932799','0','DESTOON B2B网站管理系统','0','0','姓名','','','','','','','','','','','预算','','','10000-20000元','','','destoon','1623308129','2021-06-10','127.0.0.1','','3','0','0','show.php?itemid=2','','');
INSERT INTO `destoon_info_22` VALUES('3','31','1','河南中企正新鸡排宝','','0','河南中企正新鸡排宝,首页招商推荐全国','','3','0','http://jpzzw.ja39.7890010.com/file/upload/202106/10/145551861.jpg.thumb.jpg','','','','destoon','1','1623308129','2021-06-10','1625932799','0','DESTOON B2B网站管理系统','0','0','姓名','','','','','','','','','','','预算','','','10000-20000元','','','destoon','1623308152','2021-06-10','127.0.0.1','','3','0','0','show.php?itemid=3','','');
...
CREATE TABLE `destoon_job_9` (
  ...
  KEY `catid` (`catid`),
  KEY `areaid` (`areaid`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='招聘';
...
INSERT INTO `destoon_job_9` VALUES('4','35','1','1','河南中企正新鸡排宝','','0','河南中企正新鸡排宝河南中企正新鸡排宝河南中企正新鸡排宝','河南中企正新鸡排宝,服务员,最新工作默认地区','','服务员','6','3200','6500','2','1','0','4','0','18','20','0','0','','0','destoon','1','DESTOON B2B网站管理系统','0','0','刘总','130000000000','','河南-新乡市','666@qq.com','','','堂食行业','','1','0','destoon','1623317285','2021-06-10','1623317029','2021-06-10','127.0.0.1','','3','show.php?itemid=4','','');
INSERT INTO `destoon_job_9` VALUES('5','36','1','1','刘女士','','0','刘女士刘女士刘女士刘女士刘女士刘女士刘女士','刘女士,收银,最新贤良默认地区','','收银','6','7000','8000','1','2','0','0','0','18','40','0','0','','0','destoon','1','DESTOON B2B网站管理系统','0','0','刘总','130000000000','','河南-新乡市','666@qq.com','','','堂食行业','','2','0','destoon','1623317656','2021-06-10','1623317438','2021-06-10','127.0.0.1','','3','show.php?itemid=5','','');
...
CREATE TABLE `destoon_keyword` (
  ...
  KEY `letter` (`letter`),
  KEY `keyword` (`keyword`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='关键词';
...
INSERT INTO `destoon_mall_view_16` VALUES('destoon|3','3','destoon','destoon','1624061642');
INSERT INTO `destoon_mall_view_16` VALUES('destoon|5','5','destoon','destoon','1623896194');
INSERT INTO `destoon_mall_view_16` VALUES('destoon|4','4','destoon','destoon','1623976991');
INSERT INTO `destoon_mall_view_16` VALUES('destoon|2','2','destoon','destoon','1623919504');
INSERT INTO `destoon_mall_view_16` VALUES('destoon|1','1','destoon','destoon','1623922387');
...
INSERT INTO `destoon_mall_view_16` VALUES('destoon|9','9','destoon','zq78900','1623924195');
INSERT INTO `destoon_mall_view_16` VALUES('destoon|8','8','destoon','zq78900','1623924058');
...
CREATE TABLE `destoon_member` (
  ...
  KEY `groupid` (`groupid`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='会员';

INSERT INTO `destoon_member` VALUES('1','destoon','destoon','DESTOON B2B网站管理系统','7ad8d4b7c28f95ecaf199fd0b0fb6cf7','SArPLAMn','dd018837675ccd98ca6c035591483ddb','df4CYdav','mail@yourdomain.com','0','0','0','0','1','1','姓名','13333333333','','','','','','','','1','','0','1','6','1','200','112','666.00','0.00','1623917630','127.0.0.1','1623116605','127.0.0.1','1624061620','55','1','1','1','1','0','0','0','','','','');
INSERT INTO `destoon_member` VALUES('2','zq78900','zq78900','中企电子商务','33ddb857d1cdcfad1b6552535ca135d1','GGXOvLdS','e2e81a1aa9f479a060328de1516b29b4','cuOJaVk7','','0','0','1','1','0','1','刘总','','','','','','','','','0','','0','6','6','1','0','49','0.00','0.00','1623895307','127.0.0.1','1623890648','127.0.0.1','1623999644','13','1','0','0','0','0','0','0','','','','');
...
INSERT INTO `destoon_online` VALUES('1','destoon','127.0.0.1','1','0','1624061817');
...
INSERT INTO `destoon_setting` VALUES('1','logo','http://jpzzw.ja39.7890010.com/file/upload/202106/11/143408431.png');
...
CREATE TABLE `destoon_upload_1` (
  ...
  PRIMARY KEY (`pid`),
  KEY `item` (`item`)
) ENGINE=MyISAM AUTO_INCREMENT=89 DEFAULT CHARSET=utf8 COMMENT='上传记录1';
...
CREATE TABLE `destoon_upload_2` (
  ...
  PRIMARY KEY (`pid`),
  KEY `item` (`item`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='上传记录2';
