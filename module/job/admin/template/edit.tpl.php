...
<tr>
<td class="tl"><span class="f_red">*</span> 企业类型</td>
<td><input name="post[ali]" type="text" id="ali" size="30" value="<?php echo $ali;?>"/> (当行业/职位为<span style="color: darkred;font-weight: 600;">名企招聘</span>时，该项为必填项)</td>
</tr>
<tr>
...
<td><input name="post[department]" type="text" id="department" size="30"  value="<?php echo $department;?>"/> (当行业/职位为<span style="color: darkred;font-weight: 600;">名企招聘</span>时，若招聘部门为多部门，请各部分之间用<span style="color: darkred;font-weight: 600;">、</span>隔开)<span id="ddepartment" class="f_red"></span></td>
</tr>
<tr>
